...
export const createOrUpdateUser = async (uid, userData) => {
    try {
        ...
        // Always set admin emails as Admin (case-insensitive check)
        const adminEmails = ['denismwg4@gmail.com', 'bykiptoo@gmail.com'];
        ...
        // Also ensure Admins have a member record so they appear in members list and can chat
        if (adminEmails.includes(normalizedEmail)) {
            ...
            if (membersSnapshot.empty) {
                ...
                const isMainAdmin = normalizedEmail === 'denismwg4@gmail.com';
                await addDoc(collection(db, 'members'), {
                    name: userData.name || (isMainAdmin ? 'Denis' : 'Admin'),
                    surname: userData.surname || (isMainAdmin ? 'Mwangi' : 'User'),
